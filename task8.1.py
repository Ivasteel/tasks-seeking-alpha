...
# Example usage
example_text = "dfgalphadss"

print("\n" + "-" * 50)
print("Simple Replace Function (O(N)):")
print(add_character_before_sequence_simple(example_text, "z", "alpha"))
print("-" * 50)

print("Regexp Replace Function (O(N) avg, O(NM) worst):")
print(add_character_before_sequence_re(example_text, "z", "alpha"))
print("-" * 50)

# Example with Pandas Series
series_data = ["dfgalphadss"]
series = pd.Series(series_data)
updated_series = add_character_before_sequence_series(series, "z", "alpha")
...
df_data = {"text": ["dfgalphadss", "alpha123alpha456"]}
df = pd.DataFrame(df_data)
updated_df = add_character_before_sequence_pandas(df, "text", "z", "alpha")
